package com.example.auth0.config.slownetsolver;
...
public class CustomJwtDecoders {
    ...
    public static <T extends JwtDecoder> T fromOidcIssuerLocation(String oidcIssuerLocation) throws MalformedURLException {
    ...
    private static JwtDecoder withProviderConfiguration(Map<String, Object> configuration, String issuer) throws MalformedURLException {
        ...
        CustomRemoteJWKSet<SecurityContext> jwksource = new CustomRemoteJWKSet<>(new URL(jwkSetUri));
